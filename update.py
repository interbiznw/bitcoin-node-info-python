...
ff.write("<h1>Bitcoin Node: NODE_IP_ADDRESS:8333<br \></h1>")
ff.write("<h3>")
...
ff.write("Location: New York")
ff.write("</h3>")
ff.write("<a href='https://blockchain.info/address/BITCOIN_DONATION_ADDRESS'><img src='http://qrfree.kaywa.com/?l=1&amp;s=4&amp;d=BITCOIN_DONATION_ADDRESS' alt='QRCode'></a>")
ff.write("</div>")
ff.write("</body></html>")
